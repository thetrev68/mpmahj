...
* **Jokers:** The game includes 8 Joker tiles. These are wildcards used in sets (Pungs/Kongs/Quints) but *never* in a pair (unless the pair is the literal Joker pair).
...
* **Tile Set:** 152 Tiles total.
  ...
  * **Winds:** N, E, S, W.
  * **Dragons:** Green, Red, White (Soap). *Note: White Dragon is used as 'Zero' in numerical runs.*
