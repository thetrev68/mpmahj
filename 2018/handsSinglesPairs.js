...
export const handsSinglesPairs = {
  ...
  hands: [
    {
      description:
        "NN EE WW SS 11 22 33 (1 suit, 3 consecutive numbers, concealed)",
      vsuitCount: 1,
      concealed: true,
      odd: false,
      even: false,
    ...
    {
      description:
        "FF 22 44 66 88 44 44 (3 suits, any like even pairs, concealed)",
      vsuitCount: 3,
      concealed: true,
      odd: false,
      even: true,
    ...
    {
      description:
        "FF 22 44 66 88 66 66 (3 suits, any like even pairs, concealed)",
      vsuitCount: 3,
      concealed: true,
      odd: false,
      even: true,
    ...
    {
      description:
        "FF 22 44 66 88 88 88 (3 suits, any like even pairs, concealed)",
      vsuitCount: 3,
      concealed: true,
      odd: false,
      even: true,
    ...
    {
      description:
        "FF 11 22 33 44 55 DD (1 suit, any 5 consecutive numbers, concealed)",
      vsuitCount: 1,
      concealed: true,
      odd: false,
      even: false,
