import { SUIT, DRAGON, WIND, VNUMBER } from "../../../shared/GameConstants.js";
...
export const handsQuints = {
  ...
  hands: [
    ...
    {
      description:
        "1123 11111 11111 (3 suits, any 3 consec nums, pair any number in run, pair & quints match)",
      vsuitCount: 3,
      concealed: false,
      odd: false,
      even: false,
    ...
    {
      description:
        "1223 22222 22222 (3 suits, any 3 consec nums, pair any number in run, pair & quints match)",
      vsuitCount: 3,
      concealed: false,
      odd: false,
      even: false,
    ...
    {
      description:
        "1233 11111 11111 (3 suits, any 3 consec nums, pair any number in run, pair & quints match)",
      vsuitCount: 3,
      concealed: false,
      odd: false,
      even: false,
