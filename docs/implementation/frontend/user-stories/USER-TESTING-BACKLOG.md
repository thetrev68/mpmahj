...
Last Updated: 2026-03-15. US-058 through US-073 added.
...
| [US-058](./US-058-charleston-blind-pass-contract-realignment.md)                       | Charleston Blind Pass Contract Realignment                               | Proposed  | Critical | F     |
| [US-059](./US-059-right-rail-non-playing-phase-guidance-and-occupancy.md)              | Right Rail Charleston Hint Availability and Phase Scope Correction       | Proposed  | High     | F     |
| [US-060](./US-060-runtime-noise-persistence-failures-and-debug-hygiene.md)             | Runtime Noise, Persistence Failures, and Debug Hygiene                   | Proposed  | Critical | F     |
...
| [US-062](./US-062-board-edge-alignment-rail-geometry-and-staging-boundary-recovery.md) | Board Edge Alignment, Rail Geometry, and Staging Boundary Recovery       | Proposed  | Critical | G     |
| [US-063](./US-063-board-chrome-theme-compliance-history-settings-and-rail-controls.md) | Board Chrome Theme Compliance for History, Settings, and Rail Controls   | Proposed  | High     | G     |
...
| [US-066](./US-066-play-surface-theme-root-ownership-and-board-chrome-integrity.md)     | Play Surface Theme Root Ownership and Board Chrome Integrity             | Proposed  | Critical | H     |
| [US-067](./US-067-ai-hint-capability-contract-reconciliation.md)                       | AI Hint Capability Contract Reconciliation                               | Proposed  | Critical | H     |
| [US-068](./US-068-board-layout-offset-cleanup-and-shared-alignment-grid.md)                             | Board Layout Offset Cleanup and Shared Alignment Grid                    | Proposed  | High     | H     |
...
7. Batch H (proactive audit recovery): US-066 + US-067 + US-068 + US-070 + US-071 + US-072.
...
- Recovery note: the proactive audit found root-cause gaps beyond the original user-reported bugs. Batch H captures the play-surface forced-dark theme root, the hint capability/request mismatch, and the board's magic-offset alignment debt.
