...
- **AC-6**: Inner content layout (`flex items-center gap-4 px-6 py-3`) is unchanged.
...
- **T-2**: Assert the tracker element does **not** have class `rounded-lg` (regression guard against old style).
